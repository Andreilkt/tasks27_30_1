""" Класс CupOfCoffee, c атрибутjv size_ml и свойствjv filled_ml. Добаввлена валидация значения свойства filled_ml: оно не должно превышать значение атрибута size_ml и быть меньше 0. Используйте при валидации созданные ранее классы исключений.
